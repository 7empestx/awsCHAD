...
export class S3Stack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        this.cloudfrontOAI = new cloudfront.OriginAccessIdentity(this, 'cloudfront-OAI', {
        ...
        this.myBucket.addToResourcePolicy(
            new PolicyStatement({
                ...
                principals: [
                    new iam.CanonicalUserPrincipal(this.cloudfrontOAI.cloudFrontOriginAccessIdentityS3CanonicalUserId),
                ],
            })
        );
